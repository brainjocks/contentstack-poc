...
export default () => (
  <Layout>
    ...
    <PageColumn3Wide center={
      <form action='/contact-us' method="post" netlify-honeypot="bot-field" data-netlify="true" >
        <input type="hidden" name="bot-field" />
        <h2>Let's innovate together</h2>
        <h3>770.924.6444</h3>
        <h3>Give us a call or complete the following and we will be in touch very soon.
        </h3>
        ...
        <div className="form-group">
          <textarea type="text" rows='4' placeholder='What would you like to be contacted about?' spellCheck='false' maxLength='240'/>
        </div>
        <div className="form-group privacy">
          <label>
            <input type="checkbox" value='true' is required/>
          </label>
          Yes, I understand and accept Brainjocks <a href="/" target="_new">Privacy Policy </a>
