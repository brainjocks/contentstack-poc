...
export default () =>
  (
    <Layout>
      <Head title="About"/>
      <Stripe styleName={`picture-field-720-left`} backgroundImage={background} color={`white`}>
        <HeroRight h1={`This is the H1`} h2={`H2 text`}
                   body={`lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum`}
                   children={<Btn text={`Learn More`} href={`#`} styleName={`over-dark`}/>}
        />
      </Stripe>
    </Layout>
  )