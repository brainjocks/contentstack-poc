...
import background from "../img/blue-background-girl.jpg"
...
export default () =>
  (
    <Layout>
      <Head title="Home"/>
      <Stripe styleName={data.hero.styleName} backgroundImage={background} color={data.hero.color}>
        <HeroLeft h1={data.hero.h1} h2={data.hero.h2}
                  body={data.hero.body}
                  children={<Btn text={data.hero.btnText} href={data.hero.btnHref}
                                 styleName={data.hero.btnStyleName}/>}/>
      </Stripe>
      <Stripe backgroundColor={data.centerSectionHero.backgroundColor} color={data.centerSectionHero.color}>
        <SectionHeroCenter styleName={data.centerSectionHero.heroStyleName}
      ...
      <Stripe backgroundImage={lastSectionHero} color={heroStripeColor}>
        <SectionHeroRight h2={`Interested in a career at Brainjocks?`}
