...
export default ({ data }) => (
  <Layout>
    <Head title="Home" />
    <Stripe
      styleName={jsonData.hero.styleName}
      backgroundImage={data.contentstackHomePage.hero_section.hero_background_image.url}
      color={jsonData.hero.color}
    >
      <HeroLeft
        h1={data.contentstackHomePage.hero_section.h1_text}
        h2={data.contentstackHomePage.hero_section.h2_text}
        body={data.contentstackHomePage.hero_section.hero_body_text}
        children={
          <Btn
            text={data.contentstackHomePage.hero_section.button_text}
            href={data.contentstackHomePage.hero_section.button_link.href}
            styleName={data.contentstackHomePage.hero_section.button_style_name}
          />
        }
      />
    </Stripe>
    <Stripe
      backgroundColor={jsonData.centerSectionHero.backgroundColor}
      color={jsonData.centerSectionHero.color}
    >
      <SectionHeroCenter
        styleName={jsonData.centerSectionHero.heroStyleName}
        h3={jsonData.centerSectionHero.h3}
        body={jsonData.centerSectionHero.body}
      />
    </Stripe>
    <Stripe styleName={`sticky-parent`} backgroundColor={section2Color}>
      <StickySectionRight
        ...
        src={heroImage}
        cards={jsonData.cards.map((item, index) => {
          return (
            <StyleBox
